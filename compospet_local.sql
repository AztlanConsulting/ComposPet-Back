...
--
-- Name: bitacora_id_bitacora_seq2; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.bitacora ALTER COLUMN id_bitacora ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.bitacora_id_bitacora_seq2
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
1	API	LOGIN_GOOGLE_EXITOSO	usuarios_cp	\N	\N	44444444-4444-4444-4444-444444444444	app_user	2026-04-13 16:31:05.443	\N	\N	Acceso mediante Google OAuth
2	API	LOGIN_GOOGLE_EXITOSO	usuarios_cp	\N	\N	44444444-4444-4444-4444-444444444444	app_user	2026-04-13 16:36:19.716	\N	\N	Acceso mediante Google OAuth
3	API	LOGIN_GOOGLE_EXITOSO	usuarios_cp	\N	\N	44444444-4444-4444-4444-444444444444	app_user	2026-04-13 18:00:00.694	\N	\N	Acceso mediante Google OAuth
4	API	LOGIN_GOOGLE_EXITOSO	usuarios_cp	\N	\N	44444444-4444-4444-4444-444444444444	app_user	2026-04-13 18:58:42.238	\N	\N	Acceso mediante Google OAuth
\.
...
11111111-1111-1111-1111-111111111111	55555555-5555-5555-5555-555555555555	1	2 perros	4	Dirección demo	1	Sin notas	2026-04-01	2026-12-31
\.
...
c1fc6b1d-6d85-4781-b7cd-310c2e042e56	11111111-1111-1111-1111-111111111111	3	2	200	200	2026-03-10	11:30:00	Segunda solicitud	t	t	\N
5226e859-9612-4dcf-a8df-da2b1ecc14fe	11111111-1111-1111-1111-111111111111	14	11	150.5	100	2026-02-11	09:00:00	Primera solicitud	t	f	\N
9855f04c-f55d-4497-b0b3-843cdb246248	11111111-1111-1111-1111-111111111111	10	8	100	0	2026-04-16	15:00:00	Tercera solicitud	t	f	\N
4473b9e5-2bcc-4087-ad2a-2950800ced16	11111111-1111-1111-1111-111111111111	3	2	0	0	2026-04-19	\N	\N	t	f	\N
\.
...
--
-- Name: bitacora_id_bitacora_seq2; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.bitacora_id_bitacora_seq2', 4, true);
...
--
-- Name: tarjeta_lealtad tarjeta_lealtad_id_cliente_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tarjeta_lealtad
    ADD CONSTRAINT tarjeta_lealtad_id_cliente_key UNIQUE (id_cliente);
...
--
-- Name: usuarios_cp usuarios_cp_unique_correo; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.usuarios_cp
    ADD CONSTRAINT usuarios_cp_unique_correo UNIQUE (correo);
